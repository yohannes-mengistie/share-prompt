  ...
  return (
    <div className="flex-1 break-inside-avoid rounded-lg border border-border bg-card-20 bg-clip-padding p-6 pb-4 backdrop-blur-lg backdrop-filter md:w-[360px] w-full h-fit">
      <div className="flex justify-between items-start gap-5">
        ...
        <div
          className="w-7 h-7 rounded-full bg-card-20 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.2)] backdrop-blur flex justify-center items-center cursor-pointer"
          onClick={handleCopy}
        >
          <Image
            src={
